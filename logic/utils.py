...
AZURE_OPENAI_KEY = "4V95tcXbVO3y2uyhKiAISmxC9ALiUaKvofpcEgNCoYWlBPvAatWcJQQJ99BGACfhMk5XJ3w3AAAAACOGPrhY"
...
Rules:
1. For relative periods (like "last month"), calculate exact dates based on today's date
